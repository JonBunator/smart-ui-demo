...
import {sleep, SmartComponent, SmartComponentElementProps, ValueType} from "smart-ui";

export type SmartAutocompleteProps<Value> =
...
export default function SmartSelect<Value, >(props: SmartAutocompleteProps<Value>) {
    ...
    return (
        <SmartComponent type="select" id={id} semantic={smartSemantic} options={smartOptions}
                        value={getLabel(value as Value)} smartOnChange={updateValue} required={isRequired}>
            <Autocomplete id={id}
                          disablePortal
