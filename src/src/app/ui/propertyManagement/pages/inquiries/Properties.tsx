...
export default function Properties() {
    ...
    const AddButton = (
        <SmartButton startIcon={<AddCircleIcon/>} smartSemantic="navigates to the 'add vacation home' form"
                     variant="contained" onClick={navigateToAddPage}
                     smartHref="/survey/properties/add">Hinzufügen</SmartButton>
    );
                                    ...
                                    <CardContent className="card-content">
                                            ...
                                            <div className="infos">
                                                ...
                                                <div className="info">
                                                    ...
                                                    <Typography variant="body2"
                                                                className="label">Badezimmer:</Typography>
                                                ...
                                                <div className="info">
                                                    <LocalOfferIcon/>
                                                    <Typography variant="body2"
                                                                className="label">Preis/Nacht:</Typography>
                                        ...
                                        <div className="additional-infos">
                                            {property.additionalInfos.map((info, index) => {
                                                ...
                                                return (
                                                    <Chip key={index} size="small" variant="outlined" icon={icon}
                                                          label={label}/>
                                                )
                                            })}
