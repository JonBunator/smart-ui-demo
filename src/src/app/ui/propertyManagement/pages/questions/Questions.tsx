...
import {getSurveyStep, addQuestionaireData, isInitialQuestions} from "@/lib/db/database";
...
const addDataFunctions = [addQuestionaireData, addQuestionaireData, addQuestionaireData, addQuestionaireData]
