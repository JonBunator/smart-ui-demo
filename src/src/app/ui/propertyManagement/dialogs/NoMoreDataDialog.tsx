...
export default function NoMoreDataDialog() {
    ...
    return (
        <ApprovalDialog open={snapshot?.matches({SurveyStep: "NoMoreData"}) ?? false}
                        ...
                        content={<Typography variant="body1">Es wurden alle {NUM_DATA_PER_SURVEY_STEP} E-Mails vor
                            Ablauf der Zeit dem System hinzugefügt. Wollen Sie mit der Umfrage fortfahren?</Typography>}
        />
    );
}