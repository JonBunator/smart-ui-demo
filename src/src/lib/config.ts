...
Answer in german.\
 ...
 user by clicking on buttons named Annehmen and Ablehnen to take effect. Button interactions and page navigations are executed\
 after the user accepted them. UI interactions are appended to the current state, you might\
